...
Data_Dir = 'E:\Simulation_File\windWaveAnalysis\Both_Method_example\Site14Wave\Wave';
for i=1:1:10;
    if i<10;
...
Data_Dir2 = 'E:\Simulation_File\windWaveAnalysis\Both_Method_example\Site14Wind\Wind';
for i=1:1:10;
    if i<10;
